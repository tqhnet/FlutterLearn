...
import 'dart:io';//文件操作会用到

class TestPhotoRoute extends StatefulWidget {

  @override
  TestPhotoRouteState createState() {
    return new TestPhotoRouteState();
  }
}

class TestPhotoRouteState extends State<TestPhotoRoute> {
  // File _image;
  ///记录每次选择的图片
  List<File> _images = [];
